        ...
        <>
            ...
            <div className="flex justify-center items-center w-full text-gray-200 py-9 bg-blue-30">
                ...
                <div className="flex border w-full rounded-lg overflow-hidden">
                    ...
                    <div className={`flex cursor-pointer items-center bg-gradient-to-r from-gray-900 to-pink-900 shadow-xl rounded-lg p-1 text-lg transition-all duration-500 w-full justify-center `}
                    style={{
                ...
                <div className="flex flex-col lg:flex-row w-full gap-[50px] mt-[15vh]">
                    ...
                    <form className="contact flex justify-start w-full items-center transition-all duration-500 gap-5 flex-col h-full md:w-full bg-blue-30" onSubmit={handleSubmit}>
                        ...
                        <ParallaxRight clas='w-full' id='send'>
                            <div className={`flex items-center bg-transparent shadow-xl rounded-lg p-1 text-lg transition-all duration-500 w-full justify-center cursor-pointer border`}
                            style={{
                                transform: `scale(${scale})`
                            }}
                            onMouseOver={() =>{
