  ...
  return (
    <main>
      ...
      <Card id={'award'} header={['About', ' Saculiet Driving School']} 
        ...
        buttonText={'GET STARTED Now'} buttonLink={'Contact'} img={`${db}/images/IMG-20240131-WA0009.jpg`} buttonIcon={'arrow-down'}/>
      </div>
      ...
      <Card id={'award'} header={['CHIEF EXECUTIVE OFFICER’S', ' MESSAGE']} 
        ...
        img={ceoImage} buttonIcon={'arrow-down'}/>
