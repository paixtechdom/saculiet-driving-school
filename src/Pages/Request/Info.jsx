...
export const Info = ({setShowInfo}) => {
    ...
    const notice = [
        "Sending a request without using an email connected to the organization entered will not be granted.",
    ...
    return(
        <div className="flex justify-center  bg-white h-screen absolute w-full -mt-5 px-" style={{
            zIndex: 300
        }}>
        ...
        <div className="flex-col flex w-11/12">
            ...
            <div className="flex flex-co mt-3 justify-between items-center">
                <h2 className="text-red-700 font-bold bg-white">Important Notice !</h2>
            ...
            <div className="flex flex-col gap-2 mt-3">
                {
                    notice.map((not, key) => (
                        <div key={key} className="height text-sm text-gray-700" style={{
                            lineHeight: 30+'px'
                        }}>
                            {key + 1}. {not}
                        </div>
                  ...
                  <div className="height text-sm" style={{
                            lineHeight: 30+'px'
                        }}>
